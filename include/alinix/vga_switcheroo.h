...
struct vga_switcheroo_handler {
	INTEGER (*init)(VOID);
	INTEGER (*switchto)(enum vga_switcheroo_client_id id);
	INTEGER (*switch_ddc)(enum vga_switcheroo_client_id id);
	INTEGER (*power_state)(enum vga_switcheroo_client_id id,
