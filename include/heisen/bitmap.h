...
/**
 * DOC: declare bitmap
 * The DECLARE_BITMAP(name,bits) macro, in heisen/types.h, can be used
 ...
 *
 * There are four combinations of endianness and length of the word in heisen
