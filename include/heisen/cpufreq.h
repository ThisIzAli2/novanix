/*
 * heisen/include/heisen/cpufreq.h
 *
 * Copyright (C) 2001 Russell King
 *           (C) 2002 - 2003 Dominik Brodowski <heisen@brodo.de>
 */
#ifndef _HEISEN_CPUFREQ_H
#define _HEISEN_CPUFREQ_H
