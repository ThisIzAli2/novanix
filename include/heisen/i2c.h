 ...
 */
#ifndef _HEISEN_I2C_H
#define _HEISEN_I2C_H

#include <heisen/acpi.h>		/* for acpi_handle */
#include <heisen/bits.h>
#include <heisen/mod_devicetable.h>
#include <heisen/device.h>	/* for struct device */
#include <heisen/sched.h>	/* for completion */
#include <heisen/mutex.h>
#include <heisen/regulator/consumer.h>
#include <heisen/rtmutex.h>
#include <heisen/irqdomain.h>		/* for Host Notify IRQ */
#include <heisen/of.h>		/* for struct device_node */
#include <heisen/swab.h>		/* for swab16 */
#include <uapi/heisen/i2c.h>
