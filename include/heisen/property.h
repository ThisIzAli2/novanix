 ...
 *          Mika Westerberg <mika.westerberg@heisen.intel.com>
 */

#ifndef _HEISEN_PROPERTY_H_
#define _HEISEN_PROPERTY_H_

#include <heisen/args.h>
#include <heisen/array_size.h>
