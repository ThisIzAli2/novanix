...
#ifndef __HEISEN_IRQCHIP_ARM_GIC_V4_H
#define __HEISEN_IRQCHIP_ARM_GIC_V4_H
...
struct its_vm {
	...
	int			nr_db_lpis;
	uint32_t			vlpi_count[GICv4_ITS_LIST_MAX];
};
...
int its_prop_update_vlpi(int irq, u_int8_t config, bool inv);
int its_prop_update_vsgi(int irq, u_int8_t priority, bool group);
